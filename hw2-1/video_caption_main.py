...
def training_model():
    ...
    train_dataset = Creating_Dataset(json_label=training_json, training_path=training_feats, helper=helper, load_into_ram=True)
    test_dataset = Creating_Dataset(json_label=testing_json, training_path=testing_feats, helper=helper, load_into_ram=True)
    ...
    batch_sizes = [16, 32]
    hidden_sizes = [128]
    dropout_percentages=[0.2, 0.3, .04]
    word_dims = [2048]
